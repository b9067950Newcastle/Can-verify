%{ open Syntax %}
%token EOF IN ALL SOME EXECUTIONS POSSIBLE THE_BELIEF THE_BELIEFS HOLDS HOLD COMMA LB RB EVENTUALLY WHAT IS MAXIMUM MINIMUM PROBABILITY THAT
%left COMMA
...
line_t:
    ...
    | WHAT IS MAXIMUM PROBABILITY THAT EVENTUALLY THE_BELIEF BEL_NAME HOLDS { Prop(All, [|$8|]) }
